...
- Deploy and create a Pull Request with a [DEMO LINK](https://mbrovdi.github.io/layout_landing-page/).
...
- Add your deployed demo URL to the PR description under a `Demo Link` section.
- Example format:
